...
class A:
    ...
    aptt = Abbr("aPTT", "Activated partial thromboplastin time")
    ...
    energy_tdee = Abbr("TDEE", "Total daily energy expenditure")
    energy_ree = Abbr("REE", "Resting energy expenditure")
    # fmt: on
